...
@section('content')
        ...
        <div class="box-header with-border">
            <?php $observer= App\Models\Backend\observer::find($id); ?>
            <h3 class="box-title">Πρόγραμμα Παρατηρητή: <strong>{{ $observer->waLastName }} {{ $observer->waFirstName }}</strong></h3>
    ...
    <script>
        $(function () {
            ...
            $('#referees-table').dataTable({
                ...
                stateSave: true,
                ajax: {
                    url: '{{ route("admin.file.observer.getProgram", $id) }}',
                    type: 'post',
