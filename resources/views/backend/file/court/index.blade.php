...
@section('content')
        ...
        <div class="box-header with-border">
            <h3 class="box-title">Διαχείριση Γηπέδων</h3>
        ...
        <div class="box-body">
            <div class="table-responsive">
                <table id="court-table" class="table table-condensed table-hover">
                    <thead>
                    <tr>
                        <th>Όνομα</th>
                        <th>Ομάδες που το χρησιμοποιούν</th>
...
<div id="court-modal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h3 id="termsLabel" class="modal-title">Γήπεδο-Λεπτομέρειες</h3>
      </div>
...
@section('after-scripts')
    ...
    <script>
        $(function () {
            ...
            $('#court-table').DataTable({
                processing: false,
                serverSide: true,
                autoWidth: false,
                stateSave: true,
                ajax: {
                    url: '{{ route("admin.file.court.get") }}',
                    type: 'post',
                ...
                columns: [
                    ...
                    {data: 'teams', name: 'teams', sortable: false},
        ...
        $("body").on("click", "a[name='deactivate']", function(e) {
         ...
         $('#court-table').on ('click', '.modal-trigger', function(){
          id= $(this).attr('load');
          $.get(id).done(function(data){
              $('.modal-body').html(data);
              $('#court-modal').appendTo('body').modal('show');
          }
            );
