...
@section('content')
        ...
        <div class="box-header with-border">
            <?php $court= App\Models\Backend\court::find($id); ?>
            <h3 class="box-title">Προγραμματισμένες Αναμετρήσεις: <strong>{{ $court->sort_name }}</strong></h3>
    ...
    <script>
        $(function () {
            ...
            $('#referees-table').dataTable({
                ...
                stateSave: true,
                ajax: {
                    url: '{{ route("admin.file.court.getProgram", $id) }}',
                    type: 'post',
