...
@section('content')
        ...
        <div class="box-header with-border">
            <?php $doctor= App\Models\Backend\doctor::find($id); ?>
            <h3 class="box-title">Πρόγραμμα Υγειονομικού: <strong>{{ $doctor->docLastName }} {{ $doctor->docFirstName }}</strong></h3>
    ...
    <script>
        $(function () {
            ...
            $('#referees-table').dataTable({
                ...
                stateSave: true,
                ajax: {
                    url: '{{ route("admin.file.doctor.getProgram", $id) }}',
                    type: 'post',
