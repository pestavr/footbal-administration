...
@section('content')
        ...
        <div class="box-header with-border">
            <h3 class="box-title">Διαχείριση Μεταγραφών</h3>
        ...
        <div class="box-body">
            <div class="table-responsive">
                <table id="team-table" class="table table-condensed table-hover">
                    <thead>
                    <tr>
                        <th>Δελτίο</th>
                        <th>Ονοματεπώνυμο</th>
                        <th>Ομάδα Προέλευσης</th>
                        <th>Ομάδα Προορισμού</th>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h3 id="termsLabel" class="modal-title">Μεταγραφή-Λεπτομέρειες</h3>
      </div>
    ...
    <script>
        $(function () {
            ...
            $('#team-table').DataTable({
                ...
                stateSave: true,
                ajax: {
                    url: '{{ route("admin.move.transfer.get") }}',
                    type: 'post',
                ...
                columns: [
                    {data: 'deltio', name: 'deltio'},
                    {data: 'name', name: 'name'},
                    {data: 'team_from', name: 'team_from'},
                    {data: 'team_to', name: 'team_to'},
        ...
        $("body").on("click", "a[name='deactivate']", function(e) {
                ...
                swal({
                    ...
                    text: "Είστε σίγουρος ότι θέλετε να διαγράψετε την μεταγραφή;",
                    type: "warning",
        ...
        $('#team-table').on ('click', '.modal-trigger', function(){
          id= $(this).attr('load');
