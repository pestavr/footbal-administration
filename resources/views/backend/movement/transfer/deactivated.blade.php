  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h3 id="termsLabel" class="modal-title">Ομάδα-Λεπτομέρειες</h3>
      </div>
    ...
    <script>
        $(function () {
            ...
            $('#team-table').DataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: '{{ route("admin.move.transfer.get_deactivated") }}',
                    type: 'post',
                ...
                columns: [
                    ...
                    {data: 'team_to', name: 'team_to', searchable: false, sortable: false}
                ],
