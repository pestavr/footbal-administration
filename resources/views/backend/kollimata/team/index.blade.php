...
@section('page-header')
    <h1>
        {{ app_name() }}
        <small>Κωλύματα Διαιτητών </small>
    </h1>
@endsection
...
@section('content')
        ...
        <div class="box-header with-border">
            <h3 class="box-title">Κωλύματα Διαιτητών με κάποιες Ομάδες</h3>
    ...
    <script>
        $(function () {
            ...
            $('#team-table').DataTable({
                ...
                stateSave: true,
                ajax: {
                    url: '{{ route("admin.kollimata.team.get") }}',
                    type: 'post',
                ...
                columns: [
                    ...
                    {data: 'team', name: 'team'},
                    {data: 'ref_to_team', name: 'ref_to_team'},
