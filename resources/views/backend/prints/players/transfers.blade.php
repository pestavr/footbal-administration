...
@section('page-header')
    <h1>
        {{ app_name() }}
        <small>Εκτύπωση Μεταγραφών Ομάδας</small>
    </h1>
@endsection
...
<div class="box box-success">
        <div class="box-header with-border">
             <h3 class="box-title">Μεταγραφές</h3>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                                    <label for="iso">Ομάδα Από</label>
                                    {!! Form::select('teamFrom',  $items, '',  ['class'=>'form-control', 'id'=>'teamFrom', 'data-style'=>'btn-danger', 'placeholder' => 'Επιλέξτε Ομάδα']) !!}
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                                    <label for="iso">Ομάδα Σε</label>
                                    {!! Form::select('teamTo',  $items, '',  ['class'=>'form-control', 'id'=>'teamTo', 'data-style'=>'btn-danger', 'placeholder' => 'Επιλέξτε Ομάδα']) !!}
                        </div>
                    </div>
                </div>
                <div class="row">
...
@section('after-scripts')
   {{ Html::script("https://cdn.datatables.net/v/bs/dt-1.10.15/datatables.min.js") }}
    ...
    var oTable= $('#teams-table').dataTable({
                ...
                stateSave: true,
                ajax: {
                    url: '{{ route("admin.prints.players.getTransfers") }}',
                    type: 'post',
                ...
                columns: [
                    {data: 'deltio', name: 'deltio', sortable: true},
                    {data: 'name', name: 'name', searchable: true, sortable: true},
                    {data: 'F_name', name: 'F_name', searchable: true, sortable: true},
                    {data: 'teamFrom', name: 'teamFrom', searchable: true, sortable: true},
                    {data: 'teamTo', name: 'teamTo', searchable: true, sortable: true},
                ...
                buttons: [
                    ...
                    $.extend( true, {}, buttonCommon, {
                        extend: 'print',
                        title: 'Ποδοσφαιριστές Σωματείου ',
