...
@section('page-header')
    <h1>
        {{ app_name() }}
        <small>Εκτύπωση Σκόρερς Ανά Όμιλο</small>
    </h1>
@endsection
...
<div class="box box-success">
        <div class="box-header with-border">
             <h3 class="box-title">Σκόρερ Ανά Όμιλο</h3>
...
@section('after-scripts')
   {{ Html::script("https://cdn.datatables.net/v/bs/dt-1.10.15/datatables.min.js") }}
    ...
    var oTable= $('#ranking-table').dataTable({
                ...
                stateSave: true,
                ajax: {
                    url: '{{ route("admin.prints.competition.getScorer") }}',
                    type: 'post',
                ...
                buttons: [
                    ...
                    $.extend( true, {}, buttonCommon, {
                        extend: 'pdfHtml5',
                        title: function() { return 'Σκόρερς-  '+$('#category option:selected').text(); },
                         exportOptions: {
                                            columns: ':visible'
                                        }
                    } ),
