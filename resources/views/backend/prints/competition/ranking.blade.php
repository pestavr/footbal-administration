...
@section('page-header')
    <h1>
        {{ app_name() }}
        <small>Εκτύπωση Βαθμολογίας Ανά Όμιλο</small>
    </h1>
@endsection
...
<div class="box box-success">
        <div class="box-header with-border">
             <h3 class="box-title">Βαθμολογία Ανά Όμιλο</h3>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                                    <label for="iso">Όμιλος</label>
                                    {!! Form::select('category',  $items, session()->get('category'),  ['class'=>'form-control', 'id'=>'category', 'data-style'=>'btn-danger', 'placeholder' => 'Επιλέξτε Όμιλο']) !!}
                        </div>
                    </div>
                </div>
                <div class="row">
...
<div class="box box-danger">
        <div class="box-header with-border">
             <h3 class="box-title">Βαθμολογία</h3>
...
@section('after-scripts')
   {{ Html::script("https://cdn.datatables.net/v/bs/dt-1.10.15/datatables.min.js") }}
    ...
    var oTable= $('#ranking-table').dataTable({
                ...
                stateSave: true,
                ajax: {
                    url: '{{ route("admin.prints.competition.getRanking") }}',
                    type: 'post',
                ...
                columns: [
                    {data: 'DT_Row_Index', name: 'DT_Row_Index', searchable: false, sortable: false},
                ...
                buttons: [
                    ...
                    $.extend( true, {}, buttonCommon, {
                        extend: 'pdfHtml5',
                        title: function() { return 'Βαθμολογία- '+$('#category option:selected').text(); },
                         exportOptions: {
                                            columns: ':visible'
                                        }
                    } ),
