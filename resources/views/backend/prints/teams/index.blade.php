...
@section('content')
 <div class="box box-success">
        <div class="box-header with-border">
             <h3 class="box-title">Σωματεία</h3>
        ...
        <div class="box-body">
            <div class="table-responsive">
                <div class="row">
                    ...
                    <?php $ags= App\Models\Backend\age_level::pluck('Age_Level_Title', 'id'); ?>
                    <div class="col-md-6">
                        <div class="form-group">
                                    <label for="iso">Ηλικιακές Κατηγορίες</label>
                                    {!! Form::select('ageLevel', $ags , session()->get('ageLevel'),  ['class'=>'form-control', 'id'=>'ageLevel', 'data-style'=>'btn-danger', 'placeholder' => 'Επιλέξτε Ηλικιακή Κατηγορία']) !!}
                        </div>
                    </div>
                </div>
                <div class="row">
...
@section('after-scripts')
   {{ Html::script("https://cdn.datatables.net/v/bs/dt-1.10.15/datatables.min.js") }}
    ...
    var oTable= $('#teams-table').dataTable({
                ...
                stateSave: true,
                ajax: {
                    url: '{{ route("admin.prints.teams.getTeams") }}',
                    type: 'post',
                ...
                columns: [
                    ...
                    {data: 'name', name: 'name'},
                    {data: 'ageLevel', name: 'ageLevel'},
                    {data: 'omilos', name: 'omilos'},
                    {data: 'tel', name: 'tel'},
