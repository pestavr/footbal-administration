...
@section('page-header')
    <h1>
        {{ app_name() }}
        <small>Δημιουργία Εξοδολογίων</small>
    </h1>
@endsection
...
{!! Form::open(array('url' => route("admin.prints.exodologia.doCreate"))) !!}
 ...
 {{ Html::script("https://code.jquery.com/ui/1.12.1/jquery-ui.js")}}
   {{ Html::script("https://cdn.datatables.net/v/bs/dt-1.10.15/datatables.min.js") }}
    ...
    var oTable= $('#match-table').dataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: '{{ route("admin.prints.exodologia.createPerDate") }}',
                    type: 'post',
