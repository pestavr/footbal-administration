...
<div class="box box-success">
        <div class="box-header with-border">
             <h3 class="box-title">Φύλλα Αγώνα Ανά Ημερομηνία</h3>
        ...
        <div class="box-body">
            <div class="table-responsive">
                    ...
                    <button type="button" id="show" class="btn btn-primary">Εμφάνιση</button>   
            </div><!--table-responsive-->
        </div><!-- /.box-body -->
    </div><!--box-->
{!! Form::open(array('url' => route("admin.matches.create"), "target" => "blank")) !!}
<div class="box box-danger">
        <div class="box-header with-border">
             <h3 class="box-title">Πρόγραμμα</h3>

            <div class="box-tools pull-right">
                @include('backend.access.includes.partials.create_button')
            </div><!--box-tools pull-right-->
        </div><!-- /.box-header -->
...
@section('after-scripts')
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#print_selected').on('click', function(){
                ...
                $.ajax({
                    url:'{{ route("admin.fylla.print_selected") }}',
                    type: 'post',
    ...
    var oTable= $('#match-table').dataTable({
                ...
                stateSave: true,
                ajax: {
                    url: '{{ route("admin.exodologia.create_per_date") }}',
                    type: 'post',
                    beforeSend: function (xhr) {
                        var token = $('input[name="_token"]').val();
