...
@section('page-header')
    <h1>
        {{ app_name() }}
        <small>Εκτύπωση Εξοδολογίων</small>
    </h1>
@endsection
...
<div class="box box-success">
        <div class="box-header with-border">
             <h3 class="box-title">Εκτύπωση Εξοδολογίων</h3>
...
{!! Form::open(array('url' => route("admin.prints.exodologia.print_selected"), "target" => "blank")) !!}
<div class="box box-danger">
        <div class="box-header with-border">
             <h3 class="box-title">Πρόγραμμα</h3>

            <div class="box-tools pull-right">
                @include('backend.access.includes.partials.print_button')
            </div><!--box-tools pull-right-->
        </div><!-- /.box-header -->
