        ...
        <div class="box box-success">
            ...
            <div class="box-body">
                <div class="form-group">
                    {{ Form::label('first_name', 'Όνομα', ['class' => 'col-lg-2 control-label']) }}

                    <div class="col-lg-10">
                        {{ Form::text('first_name', null, ['class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'autofocus' => 'autofocus', 'placeholder' => 'Όνομα']) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {{ Form::text('last_name', null, ['class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'placeholder' => 'Επώνυμο']) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->

                <div class="form-group">
                    {{ Form::label('mobile', 'Κινητό Τηλέφωνο',
                    ['class' => 'col-lg-2 control-label']) }}

                    <div class="col-lg-10">
                        {{ Form::text('mobile', null, ['class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'placeholder' => 'Κινητό Τηλέφωνο']) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->
