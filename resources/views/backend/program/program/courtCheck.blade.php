...
@section('after-styles')
    ...
    {{ Html::style(asset('assets/bootstrap-datetimepicker-master/bootstrap/css/bootstrap.min.css'))}}
...
<div class="box box-success">
        <div class="box-header with-border">
             <h3 class="box-title">Έλεγχος Γηπέδων</h3><br/><small>Εδώ πραγματοποιείται έλεγχος και σας εμφανίζει τις αναμετρήσεις που συμπίπτουν τα γήπεδά τους</small>
...
@section('after-scripts')
   {{ Html::script("https://cdn.datatables.net/v/bs/dt-1.10.15/datatables.min.js") }}
    ...
    var oTable= $('#match-table').dataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: '{{ route("admin.program.program.courtCheck") }}',
                    type: 'post',
