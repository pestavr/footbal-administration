...
@section('content')
        ...
        <div class="box-header with-border">
            <h3 class="box-title">Εισαγωγή Ποινής Ομάδας</h3>
        ...
        <div class="box-body">
            <div class="with-border">
                <form method="POST" action="{{ route('admin.penalty.team.do_insert') }}">
                    {{ csrf_field() }}
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="pointsoff" name="pointsoff" >
                          </div>
                        </div>
      ...
      $(function() {
           ...
           $(document).on('focus','.datepicker', function(){
            ...
            $(document).on('change','#team', function(){
              var team=$(this).val();
                  $.ajax( {
                                url: "{{ route('admin.penalty.team.getHistory') }}",
                                data: {
                                  id: team
                                },
                      ...
                      $.ajax( {
                            url: "{{ route('admin.penalty.team.recentMatches') }}",
                            data: {
                              id: team
                            },
                            success: function( data ) {
