...
@section('content')
        ...
        <div class="box-header with-border">
            <h3 class="box-title">Διαχείριση Κυπέλλου</h3>
        ...
        <div class="box-body">
            <div class="table-responsive">
                <table id="cup-table" class="table table-condensed table-hover">
                    <thead>
                    <tr>
                        <th>Όνομα</th>
                        <th>Τίτλος</th>
...
<div id="cup-modal" class="modal fade" role="dialog">
    ...
    <script>
        $(function () {
            ...
            $('#cup-table').DataTable({
                ...
                stateSave: true,
                ajax: {
                    url: '{{ route("admin.competition.cup.get") }}',
                    type: 'post',
        ...
        $("body").on("click", "a[name='deactivate']", function(e) {
                ...
                swal({
                    ...
                    text: "Είστε σίγουρος ότι θέλετε να απενεργοποιήσετε τον Όμιλο;",
                    type: "warning",
        ...
        $('#cup-table').on ('click', '.modal-trigger', function(){
          id= $(this).attr('load');
          $.get(id).done(function(data){
              $('.modal-body').html(data);
              $('#cup-modal').appendTo('body').modal('show');
          }
            );
