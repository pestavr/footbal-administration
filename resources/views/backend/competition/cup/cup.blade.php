...
@section('page-header')
    <h1>
        {{ app_name() }}
        <small>Κύπελλο- Νέα Φάση Κυπέλλου</small>
    </h1>
@endsection
...
@section('content')
{!! Form::open(array('url' => route("admin.competition.cup.saveCupMatches", config('default.cup')))) !!}
    <div class="box box-success">
        <div class="box-header with-border">
             <h3 class="box-title">Δημιουργία Νέας Φάσης Κυπέλλου</h3>
        ...
        <div class="box-body">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                                <label for="iso">Όνομα Φάσης*</label>
                                {!! Form::text('groupName', '', ['class'=>'form-control', 'id'=>'groupName', 'data-style'=>'btn-danger']) !!}
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                                <label for="iso">Γύρος*</label>
                                {!! Form::text('round', '', ['class'=>'form-control', 'id'=>'round', 'data-style'=>'btn-danger']) !!}
                    </div>
                </div>
            </div>
