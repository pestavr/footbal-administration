...
@section('page-header')
    <h1>
        {{ app_name() }}
        <small>Πρωτάθλημα- Νέα Φάση</small>
    </h1>
@endsection
...
@section('content')
{!! Form::open(array('url' => route("admin.competition.championship.saveCupMatches", config('default.cup')))) !!}
    <div class="box box-success">
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-6">
                    <?php $items= App\Models\Backend\champs::where('champ_id','<>',config('default.cup'))->where('champ_id','<','100')->pluck('category', 'champ_id'); ?>
