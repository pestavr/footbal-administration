...
@section('content')
    <div class="box box-success">
     ...
     {{Form::open(['method' => 'post', 'route' => array( 'admin.competition.championship.saveMatches',$group->id)])}}               
                    {{ csrf_field() }}
                    <?php $i=0; ?>
                    ...
                    <?php $i++; ?>
                      ...
                      @endforeach 
                       <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                          {!! Form::select('rounds', ['1'=>'Και οι δύο Γύροι','2'=> 'Πρώτος Γύρος','3'=> 'Δεύτερος Γύρος', '4'=> 'Τέσσερις Γύροι'] , '', ['class'=>'form-control']) !!}
