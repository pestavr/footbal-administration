    ...
    <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">{{ trans('labels.frontend.auth.register_box_title') }} Παρατηρητή</div>

                <div class="panel-body">

                    {{ Form::open(['route' => 'frontend.auth.register.observer.post', 'class' => 'form-horizontal']) }}
