...
return [
    ...
    */
    ...
    'frontend' => [
        'auth' => [
            'confirmation' => [
                'already_confirmed' => 'Ο λογαριασμός σας έχει ήδη επιβεβαιωθεί.',
                'confirm'           => 'Ο λογαριασμός σας επιβεβαιώθηκε!',
                'created_confirm'   => 'Ο λογαριασμός δημιουργήθηκε επιτυχώς. Όταν ενεργοποιηθεί θα σας αποσταλεί ένα ειδοποιητήριο email.',
                'created_pending'   => 'Ο λογαριασμός δημιουργήθηκε επιτυχώς. Όταν ενεργοποιηθεί θα σας αποσταλεί ένα ειδοποιητήριο email.',
