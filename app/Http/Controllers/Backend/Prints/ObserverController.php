...
class ObserverController extends Controller
{
    public function index(){
    	...
    	return view('backend.prints.observer.index');
    }

     public function orismoi(){

        return view('backend.prints.observer.orismoi');
    }
   /**
    ...
    public function show()
    {
        ...
        ->addColumn('name',function($observer){
                return $observer->waLastName.' '.$observer->waFirstName;
        })
        ->addColumn('address',function($observer){
                return $observer->Address.' TK '.$observer->tk;
        })
        ->rawColumns(['actions'])
        ->make(true);
    } 
