    ...
    Route::group(['middleware' => 'guest'], function () {
        ...
        if (config('access.users.registration')) {
            ...
            if (config('settings.observer')){
                Route::get('registerObserver', 'RegisterController@showObserverRegistrationForm')->name('registerObserver');
                Route::post('registerObserver', 'RegisterController@registerObserver')->name('register.observer.post');
            }
            if (config('settings.teamManager')){
                Route::get('registerTeamManager', 'RegisterController@showTeamManagerRegistrationForm')->name('registerTeamManager');
                Route::post('registerTeamManager', 'RegisterController@registerTeamManager')->name('register.teamManager.post');
            }    
        }
